...
-- adding a new table 'retirement_info with selected information'
SELECT first_name, last_name
...
-- Click on the ... in the Filename field to automatically select the same directory from which you 
-- imported the other CSVs. Select a directory, but be sure to rename it to retirement_info.csv.
